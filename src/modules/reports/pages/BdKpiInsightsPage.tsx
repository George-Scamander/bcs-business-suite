      ...
      {!hasData ? (
        ...
        <div className="space-y-3">
                  ...
                  <div key={row.key}>
                    ...
                    <div className="space-y-1">
                      <div className="h-2 overflow-hidden rounded app-surface-muted">
                        <div className="h-full rounded bg-slate-300 dark:bg-slate-500" style={{ width: `${targetPercent}%` }} />
                      </div>
                      <div className="h-2 overflow-hidden rounded app-surface-muted">
          ...
          <div className="grid gap-3 xl:grid-cols-[minmax(0,1.3fr)_minmax(0,1fr)]">
            ...
            >
              <div className="mb-2 text-xs app-text-soft">
                    ...
                    <tbody>
                      {completionMatrixRows.map((row) => {
                        ...
                        return (
                          <tr
                            key={row.key}
                            className={isSelected ? 'bg-blue-50/60 dark:bg-blue-900/30' : undefined}
                          >
              ...
              {!selectedBdSummary ? (
                ...
                <div className="space-y-3">
                  <div className="rounded-md border app-border app-surface-muted px-3 py-2">
                    <div className="text-xs app-text-soft">{t('pages.bdKpi.analysis.selectedBd', { defaultValue: 'Selected BD' })}</div>
                    <div className="truncate text-sm font-semibold app-text" title={selectedBdName}>
                      {selectedBdName}
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div className="rounded-md border app-border p-2">
                      <div className="text-xs app-text-soft">{t('pages.bdKpi.analysis.selectedSalesAmount', { defaultValue: 'Sales Amount' })}</div>
                      <div className="text-base font-semibold app-text">{formatCurrency(selectedBdSummary.salesAmount)}</div>
                    </div>
                    <div className="rounded-md border app-border p-2">
                      <div className="text-xs app-text-soft">{t('pages.bdKpi.analysis.selectedSalesRecords', { defaultValue: 'Sales Records' })}</div>
                      <div className="text-base font-semibold app-text">{formatNumber(selectedBdSummary.salesRecordCount)}</div>
                    </div>
                    <div className="rounded-md border app-border p-2">
                      <div className="text-xs app-text-soft">{t('pages.bdKpi.analysis.selectedBcsSigned', { defaultValue: 'BCS Signed' })}</div>
                      <div className="text-base font-semibold app-text">{formatNumber(selectedBdSummary.bcsSignedCount)}</div>
                    </div>
                    <div className="rounded-md border app-border p-2">
            ...
            >
              {!selectedBdSummary || selectedCategoryShare.total <= 0 ? (
                ...
                <div className="flex flex-col items-center gap-4 lg:flex-row lg:items-start">
                  <div className="relative h-44 w-44 shrink-0 rounded-full border app-border sm:h-56 sm:w-56" style={{ background: selectedPieGradient }}>
                    <div className="absolute left-1/2 top-1/2 flex h-24 w-24 -translate-x-1/2 -translate-y-1/2 flex-col items-center justify-center rounded-full app-surface shadow-sm">
                      <div className="text-xs app-text-soft">{t('pages.bdKpi.analysis.total', { defaultValue: 'Total' })}</div>
                      <div className="text-sm font-semibold app-text">{formatCurrency(selectedCategoryShare.total)}</div>
                    </div>
                  </div>
