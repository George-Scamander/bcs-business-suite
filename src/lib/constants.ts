...
export const NAV_ITEMS_BY_ROLE: Record<RoleCode, Array<{ key: string; label: string; path: string }>> = {
  ...
  bd_user: [
    ...
    { key: 'bd-deleted-leads', label: 'Recently Deleted Leads', path: '/app/bd/leads/deleted' },
  ...
  project_manager: [
    ...
    { key: 'pm-deleted-projects', label: 'Recently Deleted Projects', path: '/app/pm/projects/deleted' },
